  ...
  template: `
    <section class="mx-auto w-full max-w-6xl space-y-4 p-4">
      <div class="rounded-2xl bg-white p-4 shadow-sm">
        <h1 class="mb-4 text-2xl font-semibold text-slate-900">Stats</h1>
      ...
      <div *ngIf="summary() as value" class="rounded-2xl bg-white p-4 shadow-sm">
      ...
      <div *ngIf="summary() as s" class="overflow-x-auto rounded-2xl bg-white p-4 shadow-sm">
        <h2 class="mb-3 text-lg font-semibold text-slate-900">Tasks with logs in period</h2>
